...
//  Messager
//
//  Created by David Kababyan on 25/08/2020.
//
...
class ChatsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
      ...
      //  XMPPRecentListener.shared.clearUnreadCounter(recent: recent)
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            ...
            XMPPRecentListener.shared.deleteRecent(recent)
...
//        XMPPRecentListener.shared.downloadRecentChatsFromFireStore { (allChats) in
//
...
//        }
        ...
        XMPPRecentListener.shared.pollForRecentChats { [weak self] (allChats) in
            
            self?.allRecents = allChats.reversed()
...
//        navigationController?.pushViewController(privateChatView, animated: true)
        ...
        //let chatId = chatRoomIdFrom(user1Id: User.currentUserXMPP!.id, user2Id: recent.chatRoomId)

        let privateChatView = ChatViewController(chatId: recent.chatRoomId, recipientId: recent.id, recipientName: recent.receiverName == "" ? "NoUserName" : recent.receiverName)
