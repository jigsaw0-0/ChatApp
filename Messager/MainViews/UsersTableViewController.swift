...
//        XMPPUserListener.shared.downloadAllUsersFromFirebase { (allFirebaseUsers) in
//
...
//        }
        ...
        XMPPUserListener.shared.downloadRosterList(completion: { [weak self] (allXMPPUsers) in

                        self?.allUsers = allXMPPUsers
