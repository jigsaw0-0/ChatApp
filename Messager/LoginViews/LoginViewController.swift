...
class LoginViewController: UIViewController {
    ...
    private func loginUser() {
        XMPPUserListener.shared.loginUserWithEmail(email: emailTextField.text!, password: passwordTextField.text!) { (error, isEmailVerified) in
    ...
    private func registerUser() {
        ...
        if passwordTextField.text! == repeatPasswordTextField.text! {
            ...
            XMPPUserListener.shared.registerUserWith(email: emailTextField.text!, password: passwordTextField.text!) { (error) in
    ...
    private func resetPassword() {
        XMPPUserListener.shared.resetPasswordFor(email: emailTextField.text!) { (error) in
    ...
    private func resendVerificationEmail() {
        XMPPUserListener.shared.resendVerificationEmail(email: emailTextField.text!) { (error) in
